...
plt.errorbar(r1, gpu1data, yerr=[0.4,0.07,0.09], fmt="o", color="r")
plt.bar(r2, cpu1data, yerr=4.19 ,color='#557f2d', width=barWidth, edgecolor='white', label='CPU1')
plt.errorbar(r2, cpu1data, yerr=[4.19,0.05,1.3], fmt="o", color="r")
plt.bar(r3, cpu2data ,color='#2d7f5e', width=barWidth, edgecolor='white', label='CPU2')
plt.errorbar(r3, cpu2data, yerr=[3.6,7.3,2.9], fmt="o", color="r")
